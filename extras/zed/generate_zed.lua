		...
		themes = {
			{
				...
				style = {
					...
					["terminal.ansi.dim_red"] = color_utils.adjust_brightness(term.color1, 0.7),
					["terminal.ansi.green"] = term.color2,
					["terminal.ansi.bright_green"] = term.color10,
					["terminal.ansi.dim_green"] = color_utils.adjust_brightness(term.color2, 0.7),
					["terminal.ansi.yellow"] = term.color3,
					["terminal.ansi.bright_yellow"] = term.color11,
					["terminal.ansi.dim_yellow"] = color_utils.adjust_brightness(term.color3, 0.7),
					["terminal.ansi.blue"] = term.color4,
					["terminal.ansi.bright_blue"] = term.color12,
					["terminal.ansi.dim_blue"] = color_utils.adjust_brightness(term.color4, 0.7),
					["terminal.ansi.magenta"] = term.color5,
					["terminal.ansi.bright_magenta"] = term.color13,
					["terminal.ansi.dim_magenta"] = color_utils.adjust_brightness(term.color5, 0.7),
					["terminal.ansi.cyan"] = term.color6,
					["terminal.ansi.bright_cyan"] = term.color14,
					["terminal.ansi.dim_cyan"] = color_utils.adjust_brightness(term.color6, 0.7),
					["terminal.ansi.white"] = term.color7,
					["terminal.ansi.bright_white"] = term.color15,
					["terminal.ansi.dim_white"] = color_utils.adjust_brightness(term.color7, 0.7),
