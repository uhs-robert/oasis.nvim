  ...
  local manifest = {
    ...
    theme_experiment = {
      ...
      colors = {
        ...
        color_green_50 = "--color-green-50",
        color_orange_50 = "--color-orange-50",
        color_yellow_50 = "--color-yellow-50",
    ...
    theme = {
      colors = {
        ...
        tab_background_text = palette.theme.primary_light,
        ...
        primary = palette.theme.primary_strong,
        primary_hover = theme.primary,
        btn_bg = palette.bg.mantle,
        btn_bg_hover = palette.theme.primary_strong,
        ...
        color_green_60 = palette.terminal.green,
        color_green_50 = palette.terminal.bright_green,
        color_red_50 = palette.terminal.bright_red,
        color_yellow_50 = palette.terminal.yellow,
        color_orange_50 = palette.terminal.bright_yellow,
