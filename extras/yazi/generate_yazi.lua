...
local function generate_merged_theme(name, palette, output_path)
  ...
  if not theme_template then error("Failed to read theme.toml.template") end
...
local function main()
  ...
  local success_count, error_count = Utils.for_each_palette_variant(function(name, palette, mode, intensity)
    ...
    local flavor_dir = string.format("extras/yazi/themes/%s/flavors/oasis-%s.yazi", subdir, variant_name:gsub("_", "-"))
