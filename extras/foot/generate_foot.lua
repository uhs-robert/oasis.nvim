...
local function main()
	...
	for _, name in ipairs(palette_names) do
		...
		local theme = generate_foot_theme(name, palette)
		local foot_path = string.format("extras/foot/oasis_%s.ini", name)
		utils.write_file(foot_path, theme)
		print(string.format("✓ Generated: %s", foot_path))
