...
local function generate_tmux_theme(name, palette)
	...
	local lines = {
		...
		string.format('set -ogq @thm_darkyellow "%s"', string.lower(palette.syntax.statement)),
		...
		string.format('set -ogq @thm_darkteal "%s"', string.lower(palette.syntax.identifier)),
