...
local function generate_tmux_theme(name, palette)
  ...
  local lines = {
    ...
    "",
    "# Main",
    string.format('set -ogq @thm_primary_strong "%s"', string.lower(palette.theme.primary_strong)),
    string.format('set -ogq @thm_primary "%s"', string.lower(palette.theme.primary)),
    string.format('set -ogq @thm_primary_light "%s"', string.lower(palette.theme.primary_light)),
