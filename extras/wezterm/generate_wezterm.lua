...
local function generate_wezterm_theme(name, palette)
  ...
  local lines = {
    ...
    string.format('cursor_bg = "%s"', is_light and palette.syntax.statement or palette.theme.cursor),
    string.format('cursor_border = "%s"', is_light and palette.syntax.statement or palette.theme.cursor),
