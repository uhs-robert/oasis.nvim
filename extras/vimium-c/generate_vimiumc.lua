...
local function extract_vimiumc_colors(name, palette)
  ...
  return {
    ...
    link = palette.theme.primary_strong,
    border = palette.bg.mantle,
    primary = primary,
    primary_light = palette.theme.primary_light,
    secondary = secondary,
...
local function generate_vimiumc_css(name, day_palette, night_palette, intensity)
  ...
  local replacements = {
    ...
    ["{{day_primary_light}}"] = day_colors.primary_light,
    ...
    ["{{night_primary_light}}"] = night_colors.primary_light,
