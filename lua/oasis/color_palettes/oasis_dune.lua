...
local dark = {
	...
	ui = {
		...
		curSearch = { bg = p.lavender[400], fg = ui.bg.core },
		dir = p.sky[500],
...
local light_ui = vim.tbl_extend("force", {}, dark.ui)
light_ui.title = p.sunrise[700]
light_ui.primary = p.sunrise[700]
light_ui.light_primary = p.sunrise[500]
