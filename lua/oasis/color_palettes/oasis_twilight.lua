...
local base = {
  ...
  theme = {
    primary_strong = p.sundown[600],
    primary = p.sundown[500],
    primary_light = p.sundown[300],
...
local dark = {
  ...
  ui = {
    ...
    match_parent = { bg = p.visual.yellow, fg = p.khaki[600] },
    dir = p.sky[500],
...
if need_light then
  ...
  local light_ui = vim.tbl_deep_extend("force", {}, dark.ui, {
    ...
    match_parent = { bg = dark.ui.match_parent.bg, fg = base.theme.primary },
  })
