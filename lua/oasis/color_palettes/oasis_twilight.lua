...
local ui = {
	...
	-- General colors
	theme = {
		primary = p.indigo.moonlitflower,
		light_primary = p.indigo.cactusflower,
		secondary = p.yellow.moonlitsand,
		accent = p.green.springcactus,
	},
}
...
local c = {
	...
	syntax = {
		-- Cold: (Data)
		parameter = p.indigo.moonlitflower, -- (parameters) [UNIQUE]
